...
<%
	...
	case MemberDAO.NO_ID:
		response.addHeader("Refresh", "0.5;url=login.jsp?id=");
		%>
		<div class="alert alert-warning mt-5 p-5" role="alert">해당 아이디가
			없습니다!</div>
		<%
	break;
	case MemberDAO.WRONG_PW:
		response.addHeader("Refresh", "0.5;url=login.jsp?id=" + id);
		%>
		<div class="alert alert-warning mt-5 p-5" role="alert">비밀번호가 틀립니다!</div>
		<%
	break;
